...
// Standalone "More" button rendered directly in the tab bar
  ...
  return (
    <>
      ...
      >
        ...
        {/* ── Hidden secondary tabs (navigated to via More drawer) ── */}
      ...
      {/* More button floated over the right side of the tab bar */}
...
const styles = StyleSheet.create({
  ...
  // Floating More button positioned over tab bar's right slot
  moreTabBtnWrapper: {
    position: 'absolute',
    bottom: 0,
    right: 0,
    width: '20%',       // matches one tab's width in a 5-tab bar
    height: TAB_HEIGHT,
    alignItems: 'center',
